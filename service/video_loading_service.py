...
def load_video(key):
    ...
    file_name = './datasets/video/' + key
    client.download_file("highlighter234514-dev", "public/" + key, file_name)
    return True
...
def split_video(file_name):
    try:
        file_name = "./datasets/video/" + file_name
        ...
        while vid_cap.isOpened():
            ...
            if (int(vid_cap.get(1)) % round(fps) == 0):
                ...
                cv2.imwrite("./datasets/frame/" + file_name.split('/')[-1].split('.')[0] + "/%s%d.jpg" % (
